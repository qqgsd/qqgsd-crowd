                ...
                <div class="panel-body">
                    <form action="admin/save.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="loginAcct" type="text" class="form-control" id="exampleInputACCT" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">登录密码</label>
                            <input name="userPwd" type="text" class="form-control" id="exampleInputPWD" placeholder="请输入登录密码">
                        </div>
                        <div class="form-group">
