...
import com.qqgsd.crowd.entity.po.ProjectItemPicPO;
import com.qqgsd.crowd.entity.po.ProjectItemPicPOExample;
...
public interface ProjectItemPicPOMapper {
    ...
    void insertPathList(@Param("detailPicturePathList") List<String> detailPicturePathList,
